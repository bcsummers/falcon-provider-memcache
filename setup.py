# -*- coding: utf-8 -*-
"""Setup for falcon-provider-memcache package."""
# standard library
import os
...
metadata_file = os.path.join(
    os.path.abspath(os.path.dirname(__file__)), 'falcon_provider_memcache', '__metadata__.py'
)
...
setup(
    ...
    install_requires=['falcon', 'pymemcache'],
    license=metadata['__license__'],
    long_description=readme,
    long_description_content_type='text/x-rst',
    name=metadata['__package_name__'],
    packages=find_packages(exclude=['tests', 'tests.*']),
    package_dir={'falcon_provider_memcache': 'falcon_provider_memcache'},
    project_urls={
        'Documentation': 'https://github.com/bcsummers/falcon-provider-memcache/',
        'Source': 'https://github.com/bcsummers/falcon-provider-memcache/',
    },
    python_requires='>=3.6',
    scripts=[],
    test_suite='tests',
